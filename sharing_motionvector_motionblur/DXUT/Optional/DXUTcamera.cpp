...
//}
//
//void SaveScreenshot(ID3D11DeviceContext* pd3dImmediateContext, IDXGISwapChain* pSwapChain) //const
//{
...
//    if (pSwapChain->GetBuffer(0, __uuidof(ID3D11Texture2D), (LPVOID*)&backBufferTexture) != S_OK) return;
...
//
//    // Need d3dx11d.lib
//    D3DX11SaveTextureToFileW(pd3dImmediateContext, backBufferTexture, D3DX11_IFF_BMP, wideFilePath);
//
...
LRESULT CBaseCamera::HandleMessages(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    //case VK_F1:
    //{
    //    SaveScreenshot(pd3dImmediateContext, pSwapChain);
    //    break;
    //}
        case WM_KEYDOWN:
        {
