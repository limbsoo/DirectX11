...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	// m_Model 객체 초기화
	if (!m_Sphere->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), "../shadowMap/data/leather-texture-11614075174.tga", "../shadowMap/data/sphere.obj"))
	{
	...
	// m_Model 객체 초기화
	if (!m_Plane->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), "../shadowMap/data/silver-shimmery-paper-background.tga", "../shadowMap/data/plane.obj"))
	{
		MessageBox(hwnd, L"Could not initialize the model object.", L"Error", MB_OK);         
		return false;
	}
	...
	if (!m_texture->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), "../shadowMap/data/spheremap1.tga"))
	{
		return false;
	}
